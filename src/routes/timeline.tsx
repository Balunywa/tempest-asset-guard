...
export const Route = createFileRoute("/timeline")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Scrub a 24 / 48 / 72 / 120-hour operational forecast and watch asset exposure change as the storm moves.",
      },
      { property: "og:title", content: "Forecast Timeline | Gulf Asset Weather Risk" },
      { property: "og:description", content: "Time-scrubbed storm movement and corresponding asset exposure." },
    ],
  }),
