  ...
  head: () => ({
    meta: [
      { title: "Live Map | Gulf Asset Weather Risk" },
      {
        name: "description",
        content:
          "Full-screen geospatial operations view with storm track, wind, rainfall, flood and satellite layers over company assets.",
      },
      { property: "og:title", content: "Live Map | Gulf Asset Weather Risk" },
      { property: "og:description", content: "Geospatial operations view of assets and severe weather in the Gulf of Mexico." },
    ],
  }),
  component: MapPage,
});
