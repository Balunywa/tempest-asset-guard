  ...
  head: () => ({
    meta: [
      { title: "Weather Events | Gulf Asset Weather Risk" },
      {
        name: "description",
        content:
          "Active hurricanes and severe weather with trajectory, intensity, forecast cone, landfall timing and affected assets.",
      },
      { property: "og:title", content: "Weather Events | Gulf Asset Weather Risk" },
      { property: "og:description", content: "Active storm intelligence and affected asset exposure for Gulf operations." },
    ],
  }),
