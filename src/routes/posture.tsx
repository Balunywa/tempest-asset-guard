  ...
  head: () => ({
    meta: [
      { title: "Response Posture | Gulf Asset Weather Risk" },
      {
        name: "description",
        content:
          "Lead-time decision gates, shut-in status and personnel on board for every exposed Gulf of Mexico facility.",
      },
      { property: "og:title", content: "Response Posture | Gulf Asset Weather Risk" },
      {
        property: "og:description",
        content: "Track T-120 through T-24 storm response gates, production shut-in and evacuation state.",
      },
