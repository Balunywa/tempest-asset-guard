...
export const Route = createFileRoute("/deployment")({
  head: () => ({
    meta: [
      { title: "Deployment | Gulf Asset Weather Risk" },
      {
        name: "description",
        content: "Configure regions, forecasting, AI assistant, private networking, monitoring and solution packs for your own tenant.",
      },
      { property: "og:title", content: "Deployment | Gulf Asset Weather Risk" },
      { property: "og:description", content: "Deploy the operations accelerator into your own cloud subscription." },
    ],
  }),
...
const COMPONENTS = [
  ...
  { id: "sample", name: "Sample Gulf of Mexico dataset", detail: "Synthetic oil & gas estate so the app is usable on day one", on: true },
...
const PACKS = [
  "Gulf of Mexico Hurricane Operations",
  "Pipeline Flood Risk",
