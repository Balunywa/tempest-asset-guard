...
export const Route = createFileRoute("/copilot")({
  head: () => ({
    meta: [
      { title: "Operations Assistant | Gulf Asset Weather Risk" },
      {
        name: "description",
        content:
          "Ask natural-language questions about storm exposure; answers are grounded in current assets, forecasts and risk scores.",
      },
      { property: "og:title", content: "Operations Assistant | Gulf Asset Weather Risk" },
      { property: "og:description", content: "Grounded AI assistant for Gulf of Mexico weather and asset risk operations." },
    ],
  }),
