...
export const Route = createFileRoute("/assets")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Connect or import company infrastructure from CSV, GeoJSON, Shapefile, ArcGIS, cloud storage, Fabric or REST APIs.",
      },
      { property: "og:title", content: "Asset Management | Gulf Asset Weather Risk" },
      { property: "og:description", content: "Bring your own infrastructure data into the operations platform." },
    ],
  }),
